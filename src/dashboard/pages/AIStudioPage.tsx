  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 sm:px-6 md:px-8 xl:px-12 py-6 sm:py-8 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-6 gap-4">
        ...
        <div className="bg-white border border-[#EBEBEB] rounded-2xl px-5 py-3 flex items-center gap-3 min-w-[240px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start pb-8">
        ...
        <div className="lg:col-span-2 bg-white border border-[#EBEBEB] rounded-2xl p-6">
          ...
          <textarea
            ...
            rows={3}
            className="w-full p-4 bg-[#F8F8F8] border border-transparent rounded-2xl text-[13px] text-[#1A1A1A] placeholder:text-[#9A9A9A] focus:outline-none focus:bg-white focus:border-[#5B8DEF] resize-none"
